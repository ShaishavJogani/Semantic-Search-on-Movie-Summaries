...
# Data Preparation
print("Load data...")
x_train, event_x_train, ners_x_train, sent_x_train, y_train, x_test, event_x_test,  ners_x_test, sent_x_test, y_test, vocabulary, vocabulary_inv, event_voc, event_voc_inv, ners_voc, ners_voc_inv, num_labels, labels_dict = load_data()
